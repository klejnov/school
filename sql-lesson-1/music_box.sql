...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 19 2018 г., 14:47
...
(4, 'Жестокая Любовь', 1, 1, 223, 2003, 1),
(5, 'Время', 2, 2, 203, 2004, 2),
(6, 'Небо', 2, 2, 198, 2004, 2),
(7, 'Отражение', 2, 2, 301, 2004, 2),
(8, 'Время перемен', 2, 2, 354, 2004, 2),
(9, 'Птицы', 2, 2, 437, 2004, 3),
(10, 'Любовь и ненависть', 2, 2, 373, 2004, 3),
(11, 'Здравствуй мама', 3, 3, 191, 1996, 4),
(12, 'Я прошел сибирь', 3, 3, 170, 1996, 5);
...
--
ALTER TABLE `track`
  MODIFY `track_id` mediumint(7) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
