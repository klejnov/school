...
if (resultX1 === false && resultX2 === false) {
    ...
    outerMax: for (userNumberMax; x11 % 1 != 0 || x22 % 1 != 0; userNumberMax++) {
...
if (resultX1 === false && resultX2 === false) {
    ...
    document.getElementById("userNumber").innerHTML = '<span class="red">Вы ввели число <strong>' + userNumber + '</strong>. Увы, но целых решений уравнения - нет.</span><br> А вот ближайшие от вашего введенного числа значения, при которых будут целочисленные решения:';
